...
from Driver_Profile_Classification import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Driver_Profile_Classification/$', remoteuser.Predict_Driver_Profile_Classification, name="Predict_Driver_Profile_Classification"),
    ...
    url(r'^View_Predicted_Driver_Profile_Classification_Type_Ratio/$', serviceprovider.View_Predicted_Driver_Profile_Classification_Type_Ratio, name="View_Predicted_Driver_Profile_Classification_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Driver_Profile_Classification_Type/$', serviceprovider.View_Predicted_Driver_Profile_Classification_Type, name="View_Predicted_Driver_Profile_Classification_Type"),
