...
insert  into `remote_user_clientregister_model`(`id`,`username`,`email`,`password`,`phoneno`,`country`,`state`,`city`,`gender`,`address`) values (1,'shanthan','myra@gmail.com','shan','7702177291','India','telangana','hyderabad','Male','ameerpet');
...
insert  into `remote_user_detection_accuracy`(`id`,`names`,`ratio`) values (69,'SVM','54.629629629629626'),(70,'Logistic Regression','55.55555555555556'),(71,'GaussianNB','57.407407407407405'),(72,'KNeighborsClassifier','96.29629629629629');
...
insert  into `remote_user_detection_ratio`(`id`,`names`,`ratio`) values (13,'More and Bad Behaviour','100.0');
...
/*Data for the table `remote_user_driver_profile_classification` */

insert  into `remote_user_driver_profile_classification`(`id`,`sexofdriver`,`agebandofdriver`,`educationlevel`,`vehicledriverrelation`,`driverexperience`,`typeofvehicle`,`ownerofvehicle`,`defectofvehicle`,`roadsurfacecondition`,`fuelconsumption`,`Prediction`) values (16,'Male','60','Postgraduate','Employee','1 year','Car','Leased','Engine Issue','Dry','20','More and Bad Behaviour'),(17,'Female','46-60','Undergraduate','Owner','1-3 years','Bus','Private','Brake Failure','Wet','7','More and Bad Behaviour');
